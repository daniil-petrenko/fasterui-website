...
const Home = () => {
   return (
      <MainLayout>
         ...
         <Faq className="pt-21.75 max-sm:pt-15 mx-xs:pt-6 pb-[117.5px] max-md:pb-22 max-sm:pb-18 max-sm2:pb-12.5 max-xs:pb-7.5" />
         <Touch className="pt-[117.5px] max-md:pt-15 pb-39 max-sm:pt-16 max-sm2:pt-12.5 max-xs:pt-10 max-md:pb-30 max-sm:pb-25 max-xs:pb-14" />
      </MainLayout>
   );
};
